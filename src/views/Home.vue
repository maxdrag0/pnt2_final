<template>
          ...
          <ul class="navbar-nav">
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li>
                  <router-link class="dropdown-item" to="/LoginForm">Inicia sesion</router-link>
                </li>
              </ul>
            </li>
            <li class="nav-item dropdown">
  ...
  <footer>
    <h5>Contactanos!</h5>
    <a href="//wa.me/5491157962522/?text=Hola%20Maxi%20que%20buen%20trabajo%20hicieron!" target="_blank">
      Wsp
    </a>
  </footer>
</template>
